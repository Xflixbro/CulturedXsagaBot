...
async def root_route_handler(request):
    ...
    if os.path.exists(readme_path):
        try:
            ...
            # If markdown rendering fails, fall through to health check
            print(f"[route] README render failed: {e}")

    # Fallback: simple health check for UptimeRobot
    return web.Response(text="✅ Yugen FileStore Bot is running.")
